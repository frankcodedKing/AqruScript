        ...
        <div class="row align-items-center">
            <div class="col-sm-2 order-last order-sm-first">
                <ul class="social social-alt">
                    <li><a href="https://t.me/auxilliary tradexCapital" class="fa fa-paper-plane"></a></li>
            ...
            <div class="col-10 col-sm-9">
                <div class="banner-content">
                    ...
                    <h1 class="banner-heading size-sm">Welcome to auxilliary tradex Capital</h1>
...
<div class="row gutter-vr-30px justify-content-between align-items-start align-items-md-start">
    ...
    <div class="col-lg-6">
        <div class="text-block block-pad-b-100">
            <h5 class="heading-xs dash">About auxilliary tradex Capital</h5>
...
<div class="container">
    <div class="section-head section-head-s2 section-sm">
                        <h2>Choose an investment product to get started <br><span style="font-weight: 100;">to find out why over {{$company_features? $company_features->totalusers : 0}} users trust auxilliary tradex Capital</span></h2>
    </div>
    <div class="row">
        <div class="col">
            <!-- filter menu-->
...
<a href="signup.html" style="width: fit-content;">Invest in Stocks</a>
...
<a href="signup.html" style="width: fit-content;">Buy Cryptocurrencies</a>
<div style="padding: 0;margin: 0;">
...
<a href="signup.html" style="width: fit-content;">Trade Now</a>
<div style="padding: 0;margin: 0;">
...
<a href="signup.html" style="width: fit-content;" class="themebtn">Start Trading</a>
...
<div class="row justify-content-between align-items-center gutter-vr-30px">
    <div class="col-md-5">
        <div class="text-box mrm-20">
            ...
            <p>
                                    Auxilliary Tradex has been at the forefront of the digital fintech revolution since her inception.
                                    </p>
        </div>
    </div><!-- .col -->
    <div class="col-md-6">
...
<div class="row justify-content-between align-items-center gutter-vr-30px">
    ...
    <div class="col-md-6">
        <div class="text-block text-box-ml mtm-15">
                                <h2>Invest in Stocks <br><span style="font-weight: 100;">The advantages of investing in stocks on Auxilliary Tradex don’t end with pricing. There are also huge profit to be made. It is also commission-free.</span> </h2>
        ...
        <div class="text-block text-box-ml mtm-15">
                                <h2>Explore an ever-expanding variety of cryptocurrencies,<br>
                                    <span style="font-weight: 100;">
                                        and buy and sell the underlying asset on auxilliary tradex Capital’s Cryptocurrency Trading Platform.
    ...
    <div class="col-lg-6">
        <div class="team-single text-center">
            ...
            <div class="video-image">
                ...
                <a href="https://www.youtube.com/watch?v=BqkNZVAjf7E" class="video-btn video-popup"><i class="fas fa-play"></i></a>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="tes-author d-flex align-items-center">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Alexandra lukas</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I'm retired but auxilliary tradex got me! Real estate on here and crypto is bullish</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Alex Philidor</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I appreciate my colleagues for introducing me to auxilliary tradex, it's been wow since I started investing 6 months ago</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                ...
                <div class="tes-author d-flex align-items-center">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Enoch Stewart</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>Ever since I started investing with auxilliary tradex since lockdown period, I've not had issues with them</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Christiane Bescond</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I will never advocate anything that has to do with scam, so it's legit and transparent, I started with $1000, my positions with auxilliary tradex has increased since 4 months</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Oswald Dixon</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>auxilliary tradex is real, genuine and not a scam. I invested and I got paid</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Rodney wickman</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I got furloughed during the COVID-19, I couldn't survive, until a friend recommended auxilliary tradex, I can't imagine myself going back to work ever since I started investing with auxilliary tradex</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
                    ...
                    <div class="author-con">
                        <h6 class="author-name t-u">Lieven Swinkels</h6>
                                                            ...
                                                            <div class="tes-block">
                <div class="tes-content bg-light shadow-alt">
                                                <p>I'm happy that I can compound for months and receive my returns at the end of my investment, thanks auxilliary tradex</p>
                </div>
                <div class="tes-author d-flex align-items-center">
                    <div class="author-image">
